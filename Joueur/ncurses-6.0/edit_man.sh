...
TERMINFO="/info/etu/l2spi/spi2115/Projet_Semestre/rogue_like/ncurses-6.0/share/terminfo"
...
(*.[0-9]*)
	...
	if test ! -f /info/etu/l2spi/spi2115/Projet_Semestre/rogue_like/ncurses-6.0/man_alias.sed ; then
cat >>/info/etu/l2spi/spi2115/Projet_Semestre/rogue_like/ncurses-6.0/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /info/etu/l2spi/spi2115/Projet_Semestre/rogue_like/ncurses-6.0/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /info/etu/l2spi/spi2115/Projet_Semestre/rogue_like/ncurses-6.0/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	...
	sed	-f /info/etu/l2spi/spi2115/Projet_Semestre/rogue_like/ncurses-6.0/man_alias.sed \
		< $i >$TMP
